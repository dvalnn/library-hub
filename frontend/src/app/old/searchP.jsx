		...
		<div id="searchBar">
			...
			<button type="button" className="LupaBtn" onClick={handleButtonClick}>
				<svg viewBox="0 -0.24 28.423 28.423">
					<path className="lupa" d="M14.953,2.547A12.643,12.643,0,1,0,27.6,15.19,12.649,12.649,0,0,0,14.953,2.547Zm0,2A10.643,10.643,0,1,1,4.31,15.19,10.648,10.648,0,0,1,14.953,4.547Z" transform="translate(-2.31 -2.547)" fillRule="evenodd" />
					<path className="lupa" d="M30.441,28.789l-6.276-6.276a1,1,0,1,0-1.414,1.414L29.027,30.2a1,1,0,1,0,1.414-1.414Z" transform="translate(-2.31 -2.547)" fillRule="evenodd" />
				</svg>
			</button>
		</div>
	);
